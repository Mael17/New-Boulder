...
public class ListOfScorename
{
	...
	/**
	 * Le g�n�rateur d�finit la liste sur null.
	 */
...
* @return Renvoie la liste des noms de score
	...
	/**
	 * Trier la liste des participants, le score le plus �lev� et le temps le plus court sont
* premier sur la liste.
	...
	/**
	 * Ajoutez un nom de score dans la liste et placez les donn�es de la liste dans un
...
*: l'objet scorename
	...
	/** * Remplacez un nom de partition dans la liste et placez les donn�es de la liste dans un fichier de * tableau de bord.
	 * 
