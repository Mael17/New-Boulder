...
public class PanelConfig extends JPanel
{
	...
	public static void defaultConfig(FrameMenu frame)
	{
		...
		fullscreenBox = new JCheckBox("Plein �cran");
	...
	/**
	 * D�finissez la r�solution du cadre.
	 * @param res
	 */
	...
	/**
	 * R�glez le cadre en plein �cran ou en �cran normal.
* @param isFullscreen
	 */
